...
CREATE TABLE `boc_biz_oppor_follow_up`  (
  ...
  `attachment_id` bigint(20) NULL DEFAULT NULL COMMENT '附件信息ID',
...
CREATE TABLE `ding_dept`  (
  ...
  `update_time` timestamp(0) NOT NULL COMMENT '记录更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '菜单与角色关联表' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户菜单中间表' ROW_FORMAT = Compact;
